...
Three schemas exist. **They must never be mixed in one directory** — the loader
reconstructs the channel axis from band order alone, so a short record is silently
